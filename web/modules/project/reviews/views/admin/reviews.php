...
<form action="" method="get" name="form" id="form" style="float:left;">
    <div class="form_item">
        <label for="cat"><?= $text_cat_reviews ?></label></br>
		...
		<table>
			<thead>
				<tr>
					...
					<td class="last"><strong><?= $text_reviews_thead_status ?></strong>&nbsp;&nbsp;<a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
