<? if (isset($errors)) { ?>
    ...
    <? } ?>
<? } ?>
<h2 class="title"><?= $text_add_new_sertifications ?></h2>
...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		<div class="form_item">
			...
			<input type="text" name="old_price" class="text" value="<?= $post['old_price'] ?>">
		</div>
		
		<div class="form_item">
			<label for="price"><?= $text_price ?></label></br>
			<input type="text" name="price" class="text" value="<?= $post['price'] ?>">
		</div>
		
		<div class="form_item">
			<label for="code"><?= $text_code ?></label></br>
			<input type="text" name="code" class="text" value="<?= $post['code'] ?>">
		</div>
		...
		<div class="form_item" style="top:35px">
			<input type="checkbox" id="status" name="status" checked="checked" value="1"><label for="status"><?= $text_sertifications_status ?></label>
		</div>
	</div>
