...
<h2 class="title"><?= $text_specials ?> <a href="/admin/specials/add<?= $parameters ?>" title="<?= $text_add_new_specials ?>"><img src="/images/admin/add.png" style="margin-bottom:-10px;"></a></h2>
...
<?php if (isset($contents) AND count($contents) > 0): ?>
    ...
    <form method="post" action="/admin/multiaction/update" id="multiaction_form">
        <table>
            <thead>
                <tr>
                    <td><strong><?= $text_specials_thead_name ?></strong><br><a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td><strong><?= $text_specials_thead_alias ?></strong><br><a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td class="last"><strong><?= $text_specials_thead_status ?></strong><br><a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    ...
                    <td class="last"><strong><?= $text_specials_thead_action ?></strong></td>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($contents as $key => $value): ?>
                    <tr>
                        ...
                        <td class="last"><a href="/admin/specials/edit/<?= $value['id'] ?><?= $parameters ?>" class="edit"><?= $text_edit ?></a>&nbsp;&nbsp;<a href="/admin/specials/delete/<?= $value['id'] ?><?= $parameters ?>" class="delete"><?= $text_delete_img ?></a></td>
                    </tr>
        ...
        <input type="hidden" name="module" value="specials" />
    </form>
<?= $pagination2 ?>
<?php else: ?>
