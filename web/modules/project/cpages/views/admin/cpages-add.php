...
<div id="tabs">
	...
	<div id="tabs-1">
		...
		<br><br><br>
		<div class="form_item">
			<input type="checkbox" id="in_front" name="in_front" value="1"><label for="in_front"><?= $text_cpages_in_front ?></label>
		</div>
		<br>
		<div class="form_item">
			<input type="checkbox" id="status" name="status" checked="checked" value="1"><label for="status"><?= $text_cpages_status ?></label>
		</div>
	</div>
	...
	<div id="tabs-4">
		<h2 class="title"><?= $text_cpages_video ?></h2>
		<div class="form_item_textarea">
			<?php if(isset($languages)): ?>
				<?php foreach ($languages as $item): ?>
					<label for="area" class="lang_img_<?= $item['lang_id']?>"><?= $text_cpages_area ?> </label><?= $item['icon']?><textarea name="descriptions[<?= $item['lang_id']?>][area]" class="textarea_lang_<?= $item['lang_id']?>"><?= $post['descriptions'][$item['lang_id']]['area'] ?></textarea>
				<?php endforeach; ?>
			<?php else: ?>
				<label for="area"><?= $text_cpages_area ?></label><textarea name="descriptions[1][area]" class="lang_editor" id="editor3"><?= $post['descriptions'][1]['area'] ?></textarea>
			<?php endif; ?>
		</div>
	</div>
