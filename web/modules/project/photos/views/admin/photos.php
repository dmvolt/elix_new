...
<h2 class="title"><?= $text_photos ?> <a href="/admin/photos/add" title="<?= $text_add_new_photos ?>"><img src="/images/admin/add.png" style="margin-bottom:-10px;"></a></h2>
...
<?php if (isset($contents) AND count($contents) > 0): ?>
    <form method="post" action="/admin/multiaction/update" id="multiaction_form">
        <table>
            <thead>
                <tr>
                    <td><strong><?= $text_photos_thead_name ?></strong><br><a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td><strong><?= $text_photos_thead_alias ?></strong><br><a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
                    <td class="last"><strong><?= $text_photos_thead_status ?></strong><br><a onclick="$('#multiaction_form').submit();" class="btn_core btn_core_blue btn_core_sm"><span><?= $text_save ?></span></a></td>
            ...
            <tbody>
                <?php foreach ($contents as $key => $value): ?>
                    <tr>
                        ...
                        <td class="last"><a href="/admin/photos/edit/<?= $value['id'] ?>" class="edit"><?= $text_edit ?></a>&nbsp;&nbsp;<a href="/admin/photos/delete/<?= $value['id'] ?>" class="delete"><?= $text_delete_img ?></a></td>
                    </tr>
