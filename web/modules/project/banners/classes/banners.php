...
class Banners {
    ...
    public static function get_main_block($cat_alias = '', $num = 5) {
		...
		return View::factory(Data::_('template_directory') . 'banners-main')->bind('banners_data', $contents);
    }
	
	public static function get_right_block1($cat_alias = '', $num = 5) {
		...
		return View::factory(Data::_('template_directory') . 'banners-right1')->bind('banners_data', $contents);
    }
	
	public static function get_right_block2($cat_alias = '', $num = 5) {
		...
		return View::factory(Data::_('template_directory') . 'banners-right2')->bind('banners_data', $contents);
    }
