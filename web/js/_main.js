$(function() {
	...
	$('.header__nav__menu').height($('.header__adr').outerHeight());
...
var serviceDropdown = function() {
	$('.js-dropdown').each(function(){
		var $this = $(this);
		var top = $this.parent().outerHeight() + $this.parents('.service__item').position().top;
		var left = $this.parents('.service__item').position().left;
		var count = $this.children('.service__dropdown__li').index();
		var width = $this.outerWidth();
		var contWidth = $this.parents('.service').width();
...
$(document).ready(function() {
	...
	$("#faq_form").validate({
		errorClass: "form__group__message",
		errorElement: "label",
		rules: {
			name:{
				required: true,
